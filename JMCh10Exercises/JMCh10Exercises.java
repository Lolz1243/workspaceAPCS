...
public class JMCh10Exercises
{
    ...
    {
        int last = s.length();
        String ch = s.substring( last - 1);
        
        String adv = ch.concat( s.substring( 0, s.length() - 1) );
    ...
    public String convertName( String name )
    {
        ...
        String firstName = name.substring( comma + 2, last );
    ...
    public String negate( String str )
    {
        ...
        next = str.replace( '1', '2' );
        next2 = next.replace( '0', '1' );
        next3 = next2.replace( '2', '0' );
    ...
    public String cutOut( String s, String s2 )
    {
        ...
        return s.substring( 0, first ) + 
                        s.substring( first + s2.length(), s.length() );
    ...
    public String removeHtmlTags( String str )
    {
        ...
        int second = str.length() - 
                        str.substring( first, str.length() ).indexOf( "<" );
        
        return str.substring( 0, first ) + 
                        str.substring( first + 3, second - 4 );
